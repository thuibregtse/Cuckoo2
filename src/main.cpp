...
// or called locally when not in callback mode.
{
  ...
  //  TOM MOD HERE:   set the global isTrackFinished so the loop can detect end of that play
  case MD_YX5300::STS_FILE_END:   {Console.print(F("STS_FILE_END")); isTrackFinished = true;} break;
